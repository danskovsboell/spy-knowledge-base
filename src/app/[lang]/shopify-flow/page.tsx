...
export default async function ShopifyFlowPage({ params }: PageProps) {
  const { lang } = await params
  const locale = lang as Locale
  const t = getTranslations(locale)
  const article = await getArticle('shopify-flow', locale)
    ...
    <>
      ...
      {article?.content ? (
        ...
        <div className="iframe-wrapper">
          <iframe
            src={`/workflows/shopify-flow-workflow.html?lang=${locale}`}
